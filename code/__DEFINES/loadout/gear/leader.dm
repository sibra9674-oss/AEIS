GLOBAL_LIST_INIT(leader_gear_listed_products, list(
	...
	/obj/item/armor_module/module/night_vision = list(CAT_LEDSUP, "BE-35 night vision kit", 15, "blue"),
	/obj/item/clothing/glasses/night_vision = list(CAT_LEDSUP, "BE-47 night vision goggles", 25, "blue"),
